...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 11:
            ...
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", taskInfo.specifics];
            break;
        case 12:
            cell.textLabel.text = @"TimesReminded";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", taskInfo.timesReminded];
            break;
